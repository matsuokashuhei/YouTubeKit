...
public func suggestions(#keyword: String, handler: (Result<[String], NSError>) -> Void) {
    Client.sharedInstance.suggestions(keyword: keyword, handler: handler)
}

public func search(#parameters: [String: String], handler: (Result<(page: Page, items: [Video]), NSError>) -> Void) {
    Client.sharedInstance.search(parameters: parameters, handler: handler)
}

public func search(#parameters: [String: String], handler: (Result<(page: Page, items: [Playlist]), NSError>) -> Void) {
    Client.sharedInstance.search(parameters: parameters, handler: handler)
}

public func search(#parameters: [String: String], handler: (Result<(page: Page, items: [Channel]), NSError>) -> Void) {
    Client.sharedInstance.search(parameters: parameters, handler: handler)
}

public func playlistItems(#parameters: [String: String], handler: (Result<(page: Page, items: [Video]), NSError>) -> Void) {
...
public func videos(#parameters: [String: String], handler: (Result<(page: Page, videos: [Video]), NSError>) -> Void) {
